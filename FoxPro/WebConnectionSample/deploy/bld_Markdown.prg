...
EXE_FILE		  =		  	"Markdown"
DCOM_ProgId       =			"Markdown.MarkdownServer"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Markdown/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Markdown/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Markdown/wc.wc?wwmaint~FileUpload"
